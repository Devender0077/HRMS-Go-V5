...
(2, 'Rahul Verma', 'rahul.verma@email.com', '+91-9876543212', '/uploads/resumes/rahul_resume.pdf', 'Passionate about HR and employee engagement. I have 2 years of experience in recruitment and onboarding.', 2, 'People Co', 'HR Assistant', 42000.00, 15, 'applied', '2025-10-20', NOW(), NOW(), NOW()),
(3, 'Sneha Reddy', 'sneha.reddy@email.com', '+91-9876543213', '/uploads/resumes/sneha_resume.pdf', 'Creative designer with a passion for creating intuitive user experiences. My portfolio showcases various web and mobile projects.', 3, 'Design Studio', 'UI Designer', 55000.00, 30, 'interview', '2025-10-22', NOW(), NOW(), NOW()),
(4, 'Karthik Krishnan', 'karthik.k@email.com', '+91-9876543214', '/uploads/resumes/karthik_resume.pdf', 'DevOps professional with expertise in Docker, Kubernetes, and AWS. I have managed large-scale deployments.', 4, 'Cloud Systems Ltd', 'DevOps Engineer', 80000.00, 45, 'screening', '2025-10-25', NOW(), NOW(), NOW()),
