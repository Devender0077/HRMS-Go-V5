...
const models = {
  ...
  ContractSigner: require('../models/ContractSigner'),
  ...
  ContractCertificate: require('../models/ContractCertificate'),
  SignatureVerificationLog: require('../models/SignatureVerificationLog'),
