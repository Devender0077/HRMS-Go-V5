...
export default function AddCommentsPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      setLoading(true);
      // TODO: Implement annotate PDF logic via backend API
      await new Promise(resolve => setTimeout(resolve, 2000));
      enqueueSnackbar('Add Comments completed successfully!', { variant: 'success' });
    } catch (error) {
      enqueueSnackbar('Failed to annotate PDF', { variant: 'error' });
    } finally {
      setLoading(false);
    }
  };
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Card>
          <Stack spacing={3} sx={{ p: 3 }}>
            <Alert severity="info" icon={<Iconify icon="eva:message-square-outline" />}>
              <Typography variant="subtitle2" gutterBottom>
                Add Comments
              </Typography>
              <Typography variant="body2">
                Annotate PDFs with comments, highlights, and notes
              </Typography>
            </Alert>
              ...
              <>
                ...
                <List>
                  <ListItem>
                    ...
                    <ListItemText primary="Add text comments" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <Iconify icon="eva:checkmark-circle-2-fill" color="success.main" width={24} />
                    </ListItemIcon>
                    <ListItemText primary="Highlight important sections" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <Iconify icon="eva:checkmark-circle-2-fill" color="success.main" width={24} />
                    </ListItemIcon>
                    <ListItemText primary="Sticky notes and annotations" />
                  </ListItem>
                </List>
              </>
            )}
