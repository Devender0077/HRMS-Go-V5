...
export default function MetadataPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      setLoading(true);
      // TODO: Implement edit metadata PDF logic via backend API
      await new Promise(resolve => setTimeout(resolve, 2000));
      enqueueSnackbar('Edit Metadata completed successfully!', { variant: 'success' });
    } catch (error) {
      enqueueSnackbar('Failed to edit metadata PDF', { variant: 'error' });
    } finally {
      setLoading(false);
    }
  };
          ...
          <Stack spacing={3} sx={{ p: 3 }}>
            <Alert severity="info" icon={<Iconify icon="eva:info-outline" />}>
              ...
              <Typography variant="body2">
                Update PDF properties including title, author, keywords
              </Typography>
            </Alert>
              ...
              <>
                ...
                <List>
                  <ListItem>
                    ...
                    <ListItemText primary="Edit title, author, subject" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <Iconify icon="eva:checkmark-circle-2-fill" color="success.main" width={24} />
                    </ListItemIcon>
                    <ListItemText primary="Add keywords and tags" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <Iconify icon="eva:checkmark-circle-2-fill" color="success.main" width={24} />
                    </ListItemIcon>
                    <ListItemText primary="Update creation date" />
                  </ListItem>
                </List>
              </>
            )}
