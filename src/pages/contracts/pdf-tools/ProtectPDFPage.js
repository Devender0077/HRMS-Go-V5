...
export default function ProtectPDFPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      setLoading(true);
      // TODO: Implement protect PDF logic via backend API
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Card>
          <Stack spacing={3} sx={{ p: 3 }}>
            <Alert severity="info" icon={<Iconify icon="eva:lock-outline" />}>
              ...
              <>
                ...
                <List>
                  ...
                  <ListItem>
                    ...
                    <ListItemText primary="256-bit AES encryption" />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                      <Iconify icon="eva:checkmark-circle-2-fill" color="success.main" width={24} />
                    </ListItemIcon>
                    <ListItemText primary="Restrict printing and editing" />
                  </ListItem>
                </List>
              </>
            )}
