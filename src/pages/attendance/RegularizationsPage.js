                          ...
                          <TableRow key={row.id} hover>
                            <TableCell>
                              <Stack direction="row" alignItems="center" spacing={2}>
                                <Avatar alt={row.Employee ? `${row.Employee.first_name} ${row.Employee.last_name}` : 'User'} />
                                <Box>
            ...
            <Stack spacing={2} sx={{ mt: 2 }}>
              <Box>
                ...
                <Typography variant="body1">
                  {viewData.Employee ? `${viewData.Employee.first_name} ${viewData.Employee.last_name}` : 'Unknown'}
                </Typography>
              </Box>
              <Box>
