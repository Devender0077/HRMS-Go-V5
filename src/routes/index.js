      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { path: 'pdf-tools/split', element: <SplitPDFPage /> },
            { path: 'pdf-tools/rotate', element: <RotatePagesPage /> },
            { path: 'pdf-tools/reorder', element: <ReorderPagesPage /> },
            { path: 'pdf-tools/extract', element: <ExtractPagesPage /> },
            { path: 'pdf-tools/delete-pages', element: <DeletePagesPage /> },
            // Edit PDF
            { path: 'pdf-tools/edit-text', element: <EditTextPage /> },
            { path: 'pdf-tools/add-comments', element: <AddCommentsPage /> },
            { path: 'pdf-tools/crop', element: <CropPagesPage /> },
            { path: 'pdf-tools/number-pages', element: <NumberPagesPage /> },
            // Secure PDF
            { path: 'pdf-tools/protect', element: <ProtectPDFPage /> },
            { path: 'pdf-tools/watermark', element: <WatermarkPDFPage /> },
            { path: 'pdf-tools/compress', element: <CompressPDFPage /> },
            { path: 'pdf-tools/metadata', element: <MetadataPage /> },
        ...
        },
        {
          ...
          children: [
            ...
            { path: ':id/edit', element: <AssetNewPage /> },
            { path: 'categories', element: <AssetCategoriesPage /> },
            { path: 'assignments', element: <AssetAssignmentsPage /> },
            { path: 'assignments/new', element: <AssetAssignmentNewPage /> },
            { path: 'assignments/:id/edit', element: <AssetAssignmentNewPage /> },
